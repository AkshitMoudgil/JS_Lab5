...
//Pulling the image tag inside third dd element to show robot image
const robotImage = document.querySelector("#battery dd:nth-of-type(3) img");
...
function updateBatteryStatus(battery) {
  ...
  //updating api url using changeMeter.value from above
  const url = `https://robohash.org/${chargeMeter.value}.png`;
  // substituting the url in image tag
  robotImage.setAttribute("src", url);
}
